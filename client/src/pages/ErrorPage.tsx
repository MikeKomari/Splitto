...
const ErrorPage: React.FC<ErrorPageProps> = ({ code = "404", message = "Something went wrong." }) => {
  const navigate = useNavigate();

  return (
    <div className="bg-[#0d1b2a] text-white h-screen flex flex-col items-center justify-center gap-4 px-4 text-center">
      <img
        src="https://em-content.zobj.net/thumbs/240/apple/354/face-screaming-in-fear_1f631.png"
        alt="Shock Emoji"
        className="w-24 h-24"
      />
